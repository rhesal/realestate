            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        @if ($property->status == 1)
                        <form id="myForm" method="POST" action="{{ route('inactive.property') }}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $property->id }}">
                            <button type="submit" class="btn btn-primary submit">InActive</button>
                        </form>
                        @else
                        <form id="myForm" method="POST" action="{{ route('active.property') }}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $property->id }}">
