                                        ...
                                        <div class="mb-3 form-group">
                                            ...
                                            <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                                                @foreach ($amenities as $amenitie)
                                                    <option value="{{ $amenitie->amenities_name }}" {{ (in_array($amenitie->amenities_name, $property_amnt) ? 'selected' : '') }}>{{ $amenitie->amenities_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div><!-- Col -->
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" method="POST" action="{{ route('agent.update.property.thumbnail') }}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $property->id }}">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" method="POST" action="{{ route('agent.update.property.multiimage') }}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('agent.delete.property.multiimage',$img->id) }}" class="btn btn-danger" id="delete">Delete</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        </form>
                        <form id="myForm" method="POST" action="{{ route('agent.store.new.multiimage') }}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" method="POST" action="{{ route('agent.update.property.facilities') }}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $property->id }}">
